package vn.edu.topica.hocsearchview;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayAdapter<String> adpTinhThanh;
    ...
    private void addControls() {
        ...
        adpTinhThanh = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,dsTinhThanh);
        lvTinhThanh.setAdapter(adpTinhThanh);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                adpTinhThanh.getFilter().filter(newText);
                return false;
            }
        });
